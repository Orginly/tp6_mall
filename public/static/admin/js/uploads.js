layui.use(['upload'], function () {
    ...
    var uploadInst = upload.render({
        ...
        ,done: function(res){
            ...
            $('.big_image').html('<img  src="'+res.data.image+'"  class="layui-upload-img upload-img" id="main_img">');
        }
    });
        ...
        upload.render({
            ...
            ,done: function(res){
                ...
                $('#banner_img').append('<div class="img-wrap"><img src="'+ res.data.image +'"  class="layui-upload-img upload-img"><i class="layui-icon layui-icon-close btn-del"></i></div>')
        ...
        upload.render({
            ...
            ,done: function(res){
                ...
                // });
                //上传完毕
                $('#show_img').html('<div class="img-wrap"><img src="'+ res.data.image +'"  class="layui-upload-img upload-img"><i class="layui-icon layui-icon-close btn-del"></i></div>')
